...
static const uint qt_meta_data_QGLViewer[] = {
 ...
 // slots: signature, parameters, type, tag, flags
    ...
    1998, 1954,   10,   10, 0x0a,
    2058, 2042,   10,   10, 0x0a,
    2090,   10,   10,   10, 0x0a,
    2117, 2107,   10,   10, 0x0a,
    2154, 2142,   10,   10, 0x0a,
    2188, 2142,   10,   10, 0x0a,
    2214, 2142,   10,   10, 0x0a,
    2253, 2243,   10,   10, 0x0a,
    2278, 2274,   10,   10, 0x2a,
    2304, 2294,   10,   10, 0x0a,
    2356, 2294,   10,   10, 0x0a,
    2447, 2411,   10,   10, 0x0a,
    2520, 2499,   10,   10, 0x2a,
    2606, 2567,   10,   10, 0x0a,
    2687, 2662,   10,   10, 0x2a,
    2739, 2726,   10,   10, 0x2a,
    2817, 2773,   10,   10, 0x0a,
    2910, 2880,   10,   10, 0x2a,
    2974, 2956,   10,   10, 0x2a,
    3063, 3015,   10,   10, 0x0a,
    3181, 3148,   10,   10, 0x2a,
    3311, 3261,   10,   10, 0x0a,
    3436, 3400,   10,   10, 0x2a,
    3532, 3508,   10,   10, 0x2a,
    3639, 3599,   10,   10, 0x0a,
    3733, 3708,   10,   10, 0x2a,
    3852, 3797,   10,   10, 0x0a,
    3989, 3948,   10,   10, 0x2a,
    4097, 4068,   10,   10, 0x2a,
    4223, 4171,   10,   10, 0x0a,
    4353, 4316,   10,   10, 0x2a,
    4495, 4441,   10,   10, 0x0a,
    4632, 4592,   10,   10, 0x2a,
    4740, 4712,   10,   10, 0x2a,
    4859, 4815,   10,   10, 0x0a,
    4965, 4936,   10,   10, 0x2a,
    5096, 5037,   10,   10, 0x0a,
    5245, 5200,   10,   10, 0x2a,
    5365, 5332,   10,   10, 0x2a,
    5447,   10,   10,   10, 0x0a,
    5480, 2294, 5468,   10, 0x0a,
    5519, 2294, 5515,   10, 0x0a,
    5573, 5555,   10,   10, 0x0a,
    5657, 5637,   10,   10, 0x0a,
    5695, 5637,   10,   10, 0x0a,
    5739, 5731,   10,   10, 0x0a,
    5771,   10,   10,   10, 0x0a,
    5789,   10, 1512,   10, 0x0a,
    5812, 1380,   10,   10, 0x0a,
    5838, 1349,   10,   10, 0x0a,
    5858,   10,   10,   10, 0x2a,
    5871, 1349, 1512,   10, 0x0a,
    5896,   10, 1512,   10, 0x2a,
    5914,   10,   10,   10, 0x0a,
    5933,   10,   10,   10, 0x08,
    5953,   10,   10,   10, 0x08,
...
static const char qt_meta_stringdata_QGLViewer[] = {
    ...
    "setShortcut(KeyboardAction,uint)\0"
    "setKeyboardAccelerator(KeyboardAction,uint)\0"
    "key,description\0setKeyDescription(uint,QString)\0"
    "clearShortcuts()\0index,key\0"
    "setKeyFrameKey(uint,int)\0buttonState\0"
    "setPlayKeyFramePathStateKey(uint)\0"
    "setPlayPathStateKey(uint)\0"
    "setAddKeyFrameStateKey(uint)\0key,index\0"
    "setPathKey(int,uint)\0key\0setPathKey(int)\0"
    "modifiers\0setPlayPathKeyboardModifiers(Qt::KeyboardModifiers)\0"
    "setAddKeyFrameKeyboardModifiers(Qt::KeyboardModifiers)\0"
    "state,handler,action,withConstraint\0"
    "setMouseBinding(uint,MouseHandler,MouseAction,bool)\0"
    "state,handler,action\0"
    "setMouseBinding(uint,MouseHandler,MouseAction)\0"
    "state,action,doubleClick,buttonsBefore\0"
    "setMouseBinding(uint,ClickAction,bool,Qt::MouseButtons)\0"
    "state,action,doubleClick\0"
    "setMouseBinding(uint,ClickAction,bool)\0"
    "state,action\0setMouseBinding(uint,ClickAction)\0"
    "state,description,doubleClick,buttonsBefore\0"
    "setMouseBindingDescription(uint,QString,bool,Qt::MouseButtons)\0"
    "state,description,doubleClick\0"
    "setMouseBindingDescription(uint,QString,bool)\0"
    "state,description\0"
    "setMouseBindingDescription(uint,QString)\0"
    "modifiers,buttons,handler,action,withConstraint\0"
    "setMouseBinding(Qt::KeyboardModifiers,Qt::MouseButton,MouseHandler,Mou"
    "seAction,bool)\0"
    "modifiers,buttons,handler,action\0"
    "setMouseBinding(Qt::KeyboardModifiers,Qt::MouseButton,MouseHandler,Mou"
    "seAction)\0"
    "modifiers,button,action,doubleClick,buttonsBefore\0"
    "setMouseBinding(Qt::KeyboardModifiers,Qt::MouseButton,ClickAction,bool"
    ",Qt::MouseButtons)\0"
    "modifiers,button,action,doubleClick\0"
    "setMouseBinding(Qt::KeyboardModifiers,Qt::MouseButton,ClickAction,bool"
    ")\0"
    "modifiers,button,action\0"
    "setMouseBinding(Qt::KeyboardModifiers,Qt::MouseButton,ClickAction)\0"
    "modifiers,handler,action,withConstraint\0"
    "setWheelBinding(Qt::KeyboardModifiers,MouseHandler,MouseAction,bool)\0"
    "modifiers,handler,action\0"
    "setWheelBinding(Qt::KeyboardModifiers,MouseHandler,MouseAction)\0"
    "modifiers,button,description,doubleClick,buttonsBefore\0"
    "setMouseBindingDescription(Qt::KeyboardModifiers,Qt::MouseButton,QStri"
    "ng,bool,Qt::MouseButtons)\0"
    "modifiers,button,description,doubleClick\0"
    "setMouseBindingDescription(Qt::KeyboardModifiers,Qt::MouseButton,QStri"
    "ng,bool)\0"
    "modifiers,button,description\0"
    "setMouseBindingDescription(Qt::KeyboardModifiers,Qt::MouseButton,QStri"
    "ng)\0"
    "key,modifiers,buttons,handler,action,withConstraint\0"
    "setMouseBinding(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButton,MouseHan"
    "dler,MouseAction,bool)\0"
    "key,modifiers,buttons,handler,action\0"
    "setMouseBinding(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButton,MouseHan"
    "dler,MouseAction)\0"
    "key,modifiers,button,action,doubleClick,buttonsBefore\0"
    "setMouseBinding(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButton,ClickAct"
    "ion,bool,Qt::MouseButtons)\0"
    "key,modifiers,button,action,doubleClick\0"
    "setMouseBinding(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButton,ClickAct"
    "ion,bool)\0"
    "key,modifiers,button,action\0"
    "setMouseBinding(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButton,ClickAct"
    "ion)\0"
    "key,modifiers,handler,action,withConstraint\0"
    "setWheelBinding(Qt::Key,Qt::KeyboardModifiers,MouseHandler,MouseAction"
    ",bool)\0"
    "key,modifiers,handler,action\0"
    "setWheelBinding(Qt::Key,Qt::KeyboardModifiers,MouseHandler,MouseAction"
    ")\0"
    "key,modifiers,button,description,doubleClick,buttonsBefore\0"
    "setMouseBindingDescription(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButt"
    "on,QString,bool,Qt::MouseButtons)\0"
    "key,modifiers,button,description,doubleClick\0"
    "setMouseBindingDescription(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButt"
    "on,QString,bool)\0"
    "key,modifiers,button,description\0"
    "setMouseBindingDescription(Qt::Key,Qt::KeyboardModifiers,Qt::MouseButt"
    "on,QString)\0"
    "clearMouseBindings()\0MouseAction\0"
    "wheelAction(Qt::KeyboardModifiers)\0"
    "int\0wheelHandler(Qt::KeyboardModifiers)\0"
    "handler,modifiers\0"
    "setHandlerKeyboardModifiers(MouseHandler,Qt::KeyboardModifiers)\0"
    "handler,buttonState\0"
    "setHandlerStateKey(MouseHandler,uint)\0"
    "setMouseStateKey(MouseHandler,uint)\0"
...
void QGLViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 111: { MouseAction _r = _t->wheelAction((*reinterpret_cast< Qt::KeyboardModifiers(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< MouseAction*>(_a[0]) = _r; }  break;
