...
static const char qt_meta_stringdata_qglviewer__KeyFrameInterpolator[] = {
    ...
    "addKeyFrame(Frame,qreal)\0"
    "addKeyFrame(Frame*const)\0"
    "addKeyFrame(Frame*const,qreal)\0"
    "deletePath()\0setFrame(Frame*const)\0"
    "time\0setInterpolationTime(qreal)\0speed\0"
    "setInterpolationSpeed(qreal)\0period\0"
    ...
    "toggleInterpolation()\0interpolateAtTime(qreal)\0"
